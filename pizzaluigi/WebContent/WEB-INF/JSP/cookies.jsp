...
<fmt:setBundle basename='resourceBundles.teksten'/> <!doctype html>
<html lang='nl'>
  <head>
  ...
  <body>
    <vdab:menu/> 
    <h1><fmt:message key='cookieVoorbeeld'/></h1>     <form method='post'>
    ...
    <c:if test='${not empty naam}'>
      <div>
        <fmt:message key='naamLetters'>
          <fmt:param value='${naam.length()}'/>         </fmt:message>
      </div>
    </c:if>
  	<div>
